...
(function (factory) {
  ...
  var _timer = 0,
      ...
      initEvent = function () {
        var $blocks = $(this).find ('.silders'),
            ...
            blockWidth = parseFloat ($firstBlock.css ('width')) + parseFloat ($firstBlock.css ('margin-left')) + parseFloat ($firstBlock.css ('margin-right')) + ($firstBlock.css ('box-sizing') != 'border-box' ? (parseFloat ($firstBlock.css ('border-left-width')) + parseFloat ($firstBlock.css ('border-right-width')) + parseFloat ($firstBlock.css ('padding-left')) + parseFloat ($firstBlock.css ('padding-right'))) : 0),
  ...
  $.fn.sliderView = function (options) {
