    ...
    OAscrollSliderView: function (opt) {
      ...
      init = function (opt) {
        ...
        var timer = null,
            ...
            $leftArrow = $('<div />').addClass ('oa-scrollSliderView-arrow-left').css ({'width': (parseFloat ($(this).data ('arrow_width') ? $(this).data ('arrow_width') : opt.arrow.width) - 1) + 'px', 'line-height': h}).append ($(this).attr ('data-arrow_leftSvg') ? $(this).attr ('data-arrow_leftSvg') : opt.arrow.leftSvg).hide (),
            $rightArrow = $('<div />').addClass ('oa-scrollSliderView-arrow-right').css ({'width': (parseFloat ($(this).data ('arrow_width') ? $(this).data ('arrow_width') : opt.arrow.width) - 1) + 'px', 'line-height': h}).append ($(this).attr ('data-arrow_rightSvg') ? $(this).attr ('data-arrow_rightSvg') : opt.arrow.rightSvg).hide ();
